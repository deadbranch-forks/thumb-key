...
const val DEFAULT_KEYBOARD_GESTURES_SENSITIVITY = 5
...
data class AppSettings(
    ...
    @ColumnInfo(
        name = "keyboard_gestures_sensitivity",
        defaultValue = DEFAULT_KEYBOARD_GESTURES_SENSITIVITY.toString(),
    )
    val keyboardGesturesSensitivity: Int,
    @ColumnInfo(
...
data class BehaviorUpdate(
    ...
    val slideHoldEnabled: Int,
    @ColumnInfo(name = "keyboard_gestures_sensitivity")
    val keyboardGesturesSensitivity: Int,
)
